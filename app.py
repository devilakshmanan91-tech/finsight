...
.hero h1 {
    ...
    font-size:3.5rem; color:#fff; margin:0; letter-spacing:-1px;
}
...
.features h2 {
    font-family:'Playfair Display',serif;
    color:#f1f5f9; font-size:2rem; margin-bottom:0.5rem;
}
...
.how-section {
    background:#060b14; padding:4rem 2rem; text-align:center;
    border-top:1px solid #1e293b;
}
.how-section h2 {
    font-family:'Playfair Display',serif;
    color:#f1f5f9; font-size:2rem; margin-bottom:3rem;
}
.steps-row {
    display:flex; justify-content:center;
    gap:2rem; flex-wrap:wrap; max-width:900px; margin:0 auto;
}
.step-card {
    background:#111827; border:1px solid #1e293b;
    border-radius:16px; padding:1.5rem; width:160px;
}
.step-number {
...
.about-section {
    background:#0f172a; padding:4rem 2rem; text-align:center;
    border-top:1px solid #1e293b;
}
.about-section h2 {
    font-family:'Playfair Display',serif;
    color:#f1f5f9; font-size:2rem; margin-bottom:1rem;
}
.about-section p {
    color:#64748b; max-width:700px;
    margin:0 auto 2rem auto; line-height:1.8;
}
...
.metric-value {
    font-family:'Playfair Display',serif;
    font-size:1.8rem; color:#f1f5f9; font-weight:700;
}
.metric-label {
...
.footer {
    background:#060b14; text-align:center; color:#334155;
    font-size:0.85rem; padding:2rem; border-top:1px solid #1e293b;
}
...
if st.session_state.page == "landing":
    ...
    <div class="features">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <div class="feature-desc">Real-time NSE stock prices and SIP projections fetched instantly from Yahoo Finance</div>
            </div>
            <div class="feature-card">
                <div class="feature-icon">💰</div>
                <div class="feature-title">Budget Analysis</div>
                <div class="feature-desc">AI analyses your income and expenses to find the best savings strategy for you</div>
            </div>
            <div class="feature-card">
            ...
            <div class="feature-card">
                ...
                <div class="feature-desc">bcrypt encrypted passwords — only you can see your financial reports</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="about-section">
        ...
        <p>
            FinSight is an Agentic AI personal finance advisor built specifically
            ...
            by Groq LLaMA 3.3 for personalised conversations. Built with Python,
            Streamlit, and cutting-edge AI — FinSight makes professional financial
    ...
    st.markdown("""
    <div class="footer">
        Built with ❤️ by <b>Devi</b> ·
        FinSight — Agentic AI Personal Finance Advisor<br>
...
# ══════════════════════════════════════════════════════════════
    ...
    nu  = st.text_input("👤 Username",
                        placeholder="e.g. devi2024")
    em  = st.text_input("📧 Email Address",
                        placeholder="e.g. devi@gmail.com")
...
# ══════════════════════════════════════════════════════════════
    ...
    if st.session_state.is_admin:
        ...
        <div class="metric-row">
            ...
            <div class="metric-card">
                ...
                <div class="metric-label">System Live</div>
            </div>
            <div class="metric-card">
                <div class="metric-value">🤖</div>
    ...
    # ── USER DASHBOARD ────────────────────────────────────────
        ...
        with col1:
            ...
            <div style="background:#0f172a;border:1px solid #1e293b;
                ...
                <span style="color:#475569;font-size:0.9rem;margin-left:1rem;">
                    Generate plan → Chat with AI → Track history
                </span>
            </div>""", unsafe_allow_html=True)
        with col2:
            if st.button("Logout"):
        ...
        with tab_plan:
            ...
            c3, c4 = st.columns(2)
            with c3:
                stock = st.text_input("NSE Stock Symbol",
                        value="RELIANCE",
            ...
            with rc1:
                st.markdown("""<div style="background:#064e3b;border-radius:8px;
                    padding:0.5rem;text-align:center;font-size:0.8rem;color:#6ee7b7;">
                    🟢 <b>Low</b><br>Safe · FD · PPF</div>""",
                    unsafe_allow_html=True)
            with rc2:
                st.markdown("""<div style="background:#451a03;border-radius:8px;
                    padding:0.5rem;text-align:center;font-size:0.8rem;color:#fbbf24;">
                    🟡 <b>Medium</b><br>Balanced · Index funds</div>""",
                    unsafe_allow_html=True)
            with rc3:
                st.markdown("""<div style="background:#450a0a;border-radius:8px;
                    padding:0.5rem;text-align:center;font-size:0.8rem;color:#fca5a5;">
                    🔴 <b>High</b><br>Aggressive · Stocks</div>""",
                    unsafe_allow_html=True)
            risk_level = st.radio("", ["low","medium","high"],
        ...
        with tab_chat:
            ...
            <div style="background:#0f172a;border:1px solid #1e293b;
                ...
                💡 AI gives <b style="color:#38bdf8;">personalised advice</b>
                based on YOUR data. Generate plan first, then chat!
            </div>""", unsafe_allow_html=True)
            ...
            if not st.session_state.last_context:
                ...
                <div style="text-align:center;background:#0f172a;
                    ...
                    <div style="font-size:1.1rem;color:#64748b;margin-top:1rem;">
                        Go to 🚀 Financial Plan tab first!
                    </div>
                </div>""", unsafe_allow_html=True)
            else:
                ...
                <div style="background:#0f172a;border:1px solid #10b981;
                            ...
                            margin-bottom:1rem;color:#6ee7b7;font-size:0.85rem;">
